...
if __name__ == "__main__":
    ...
    for step_i in range(200): 
        # Action: [1.0 (Max Glucose Feed), 0.0 (Base), trace_action (Trace Nutrient)]
        # After step 160, activate trace nutrient feed [1.0, 0.0, 0.5] to trigger chemical bypass!
        trace_action = 0.5 if step_i >= 160 else -1.0
        obs, reward, term, trunc, info = env.step([1.0, 0.0, trace_action])
